        ...
        $.post(_action, _data, function(_result){
            ...
            if (is_json(_result)) {
                ...
                //   $('#loading').show();
                  ...
                  $.ajax({
                    url: "https://bongofollowers.com/add_funds/zenopay/getStatus",
                    type: "POST",
                    ...
                    success: function (response) {
                        ...
                        if(response1.success){
                            window.location.href = "https://bongofollowers.com"
                        }else{
                             window.location.href = "https://bongofollowers.com/add_funds/unsuccess"
                        }
                    },
                  });
                }
               
                getOrderStatus(_result.order_id)
                ...
                setTimeout(function(){
                  ...
                  pageOverlay.hide(); //added machele
