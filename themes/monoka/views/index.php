            ...
            <div class="container">
                <div class="row text-container">
                    <div class="col-lg-8 col-xl-7">
                        <div class="">
                            <h1><?php echo lang("Bongo_Followers"); ?></h1>
    ...
    <section class="how-it-works">
        <div class="container">
            <div class="col-lg-12 text-center header-top" data-aos="fade-up" data-aos-duration="500">
                ...
                <h2 class="h2-heading"><?php echo lang("Kwa_kufuata_taratibu_zilizo_hapa_chini_unaweza_kufanya_agizo_lolote_unalotaka"); ?></h2>
            </div> 
            <div class="row how-it-works-row justify-content-start">
                <div class="col-md-3 how-it-works-col" data-aos="fade-up" data-aos-duration="800">
                    <div class="how-it-works-card">
                        ...
                        <div class="how-it-works-title">
                            <p class="text-center"><span><strong><?php echo lang("register_and_log_in / fungua akaunti"); ?></strong></span></p>
                        </div>
                        <div class="how-it-works-description">
                            <p class="text-center"><span><?php echo lang("Kuunda_akaunti_ni_hatua_ya_kwanza_basi_unahitaji_kuingia."); ?></span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 how-it-works-col" data-aos="fade-up" data-aos-duration="1600">
                    <div class="how-it-works-card">
                        ...
                        <div class="how-it-works-title">
                            <p class="text-center"><span><strong><?php echo lang("add_funds / ongeza_pesa"); ?></strong></span></p>
                        </div>
                        <div class="how-it-works-description">
                            <p class="text-center"><span><?php echo lang("Kisha,chagua_njia_ya_kulipa_na_uongeze_pesa_kwenye_akaunti_yako."); ?></span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 how-it-works-col" data-aos="fade-up" data-aos-duration="2400">
                    <div class="how-it-works-card">
                        ...
                        <div class="how-it-works-title">
                            <p class="text-center"><span><strong><?php echo lang("select_a_service / chagua_huduma"); ?></strong></span></p>
                        </div>
                        <div class="how-it-works-description">
                            <p class="text-center"><span><?php echo lang("Chagua_huduma_unazotaka_na_uwe_tayari_kupokea_utangazaji_zaidi."); ?></span></p>
                        </div>
                    </div>
                </div>
                ...
                <div class="col-md-3 how-it-works-col" data-aos="fade-up" data-aos-duration="3000">
                    <div class="how-it-works-card">
                        ...
                        <div class="how-it-works-title">
                            <p class="text-center"><span><strong><?php echo lang("enjoy_superb_results / furahia_matokeo_mazuri"); ?></strong></span></p>
                        </div>
                        <div class="how-it-works-description">
                            <p class="text-center"><span><?php echo lang("Unaweza_kufurahia_matokeo_ya_ajabu_wakati_agizo_lako_limekamilika."); ?></span></p>
                        </div>
                    </div>
                </div>
            </div>
