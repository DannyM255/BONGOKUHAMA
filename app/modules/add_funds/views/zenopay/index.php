    ...
    <div class="row">
      <div class="col-md-12">
        ...
        <div class="form-group">
          ...
          <input class="form-control square" type="number" name="phone_number" placeholder="0766******">
        </div>   
        ...
        <div class="form-actions left">
          ...
          <input type="hidden" name="payment_method" value="zenopay">
          <button type="submit" class="btn round btn-primary btn-min-width mr-1 mb-1">
            <?=lang("Pay")?>
          </button>
        </div>
        <div id="loading" style="display:flex; flex-direction:column;"  class="payment-info text-center">
            <strong class="text-danger">Please wait do no change this page</strong>
            <img src="https://kuzachap.com/assets/images/loading.gif" alt=""/>
        </div>
      </div>  
    </div>
  </form>
